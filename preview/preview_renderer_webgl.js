export class WebGlRenderer {
    constructor(canvas) {
        this.currentAtlasTexture = null;
        this.textureByAtlasId = new Map();
        this.canvas = canvas;
    ...
    async loadAtlasTextures(json, resourceStore) {
        this.textureByAtlasId.clear();
        const basePath = window.LMB_PREVIEW_ATLAS_BASE_PATH || "";
    ...
    renderScene(instances) {
        ...
        for (const instance of instances) {
            ...
            gl.uniform4f(this.colorMultLocation, colorMult.r / 256.0, colorMult.g / 256.0, colorMult.b / 256.0, colorMult.a / 256.0);
            gl.uniform4f(this.colorAddLocation, colorAdd.r / 256.0, colorAdd.g / 256.0, colorAdd.b / 256.0, colorAdd.a / 256.0);
    ...
    buildOrthoMatrix(stageWidth, stageHeight, m) {
