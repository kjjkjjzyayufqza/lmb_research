...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Lmb || (root.Lmb = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Lmb_, KaitaiStream) {
var Lmb = (function() {
  Lmb.BlendMode = Object.freeze({
    NORMAL: 0,
    LAYER: 2,
    MULTIPLY: 3,
    SCREEN: 4,
  ...
  Lmb.PlacementMode = Object.freeze({
    PLACE: 1,
    MOVE: 2,
  ...
  Lmb.PositionFlags = Object.freeze({
    TRANSFORM: 0,
    POSITION: 32768,
    NO_TRANSFORM: 65535,
  ...
  function Lmb(_io, _parent, _root) {
    this._io = _io;
  ...
  Lmb.prototype._read = function() {
    this.lmb = new LmbType(this._io, this, this._root);
  }

  var Actionscript = Lmb.Actionscript = (function() {
  ...
  var Bounds = Lmb.Bounds = (function() {
  ...
  var Button = Lmb.Button = (function() {
  ...
  var Colors = Lmb.Colors = (function() {
  ...
  var DefineSprite = Lmb.DefineSprite = (function() {
  ...
  var Defines = Lmb.Defines = (function() {
  ...
  var DoAction = Lmb.DoAction = (function() {
  ...
  var DynamicText = Lmb.DynamicText = (function() {
  ...
  var FrameLabel = Lmb.FrameLabel = (function() {
  ...
  var Graphic = Lmb.Graphic = (function() {
  ...
  var LmbType = Lmb.LmbType = (function() {
    ...
    Object.defineProperty(LmbType.prototype, 'tags', {
      get: function() {
        if (this._m_tags !== undefined)
          return this._m_tags;
        this._m_tags = this.tagsBlock.tags;
        return this._m_tags;
      }
    });
    Object.defineProperty(LmbType.prototype, 'tagsBlock', {
      get: function() {
        if (this._m_tagsBlock !== undefined)
          return this._m_tagsBlock;
        var _pos = this._io.pos;
        this._io.seek(this._io.pos);
        this._raw__m_tagsBlock = this._io.readBytes(this.totalFileLen - this._io.pos);
        var _io__raw__m_tagsBlock = new KaitaiStream(this._raw__m_tagsBlock);
        this._m_tagsBlock = new TagBlock(_io__raw__m_tagsBlock, this, this._root);
        this._io.seek(_pos);
        return this._m_tagsBlock;
      }
    });
  ...
  var Nothing = Lmb.Nothing = (function() {
  ...
  var PlaceObject = Lmb.PlaceObject = (function() {
  ...
  var Positions = Lmb.Positions = (function() {
  ...
  var Properties = Lmb.Properties = (function() {
  ...
  var RemoveObject = Lmb.RemoveObject = (function() {
  ...
  var Symbols = Lmb.Symbols = (function() {
  ...
  var Tag = Lmb.Tag = (function() {
    ...
    Tag.prototype._read = function() {
      ...
      switch (this.tagType) {
      case Lmb.Tag.FlashTagType.ACTION_SCRIPT:
      ...
      this.children = [];
      for (var i = 0; i < (this.tagType == Lmb.Tag.FlashTagType.DEFINES ? this.data.numChildren : (this.tagType == Lmb.Tag.FlashTagType.KEYFRAME ? this.data.numChildren : (this.tagType == Lmb.Tag.FlashTagType.SHOW_FRAME ? this.data.numChildren : (this.tagType == Lmb.Tag.FlashTagType.DEFINE_SPRITE ? this.data.numChildren : (this.tagType == Lmb.Tag.FlashTagType.BUTTON ? this.data.numChildren : (this.tagType == Lmb.Tag.FlashTagType.PLACE_OBJECT ? this.data.numChildren : 0)))))); i++) {
  ...
  var TagBlock = Lmb.TagBlock = (function() {
    function TagBlock(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    TagBlock.prototype._read = function() {
      this.tags = [];
      var i = 0;
      while (!this._io.isEof()) {
  ...
  var TextureAtlases = Lmb.TextureAtlases = (function() {
  ...
  var TexturesType = Lmb.TexturesType = (function() {
  ...
  var Transforms = Lmb.Transforms = (function() {
